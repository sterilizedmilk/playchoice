...
-- Table `play`.`show`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `play`.`show` (
...
-- -----------------------------------------------------
-- Placeholder table for view `play`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `play`.`view1` (`id` INT);

-- -----------------------------------------------------
-- View `play`.`view1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `play`.`view1`;
USE `play`;
